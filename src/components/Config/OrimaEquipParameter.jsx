...
export const OrimaEquipParameter = () => <div className='bg-sky-1200 w-full h-full p-8 flex flex-wrap flex-col'>
    ...
    <ConfigInput iconType="icon" iconId="vitalsystem1" value="VitalSystem1" type="number" />
    <ConfigInput iconType="icon" iconId="vitalsystem2" value="VitalSystem2" type="number" />
    <ConfigInput iconType="icon" iconId="vitalsystem3" value="VitalSystem3" type="number" />
    <ConfigInput iconType="icon" iconId="metalsystem1" value="MetalSystem1" type="number" />
    <ConfigInput iconType="icon" iconId="metalsystem2" value="MetalSystem2" type="number" />
    <ConfigInput iconType="icon" iconId="metalsystem3" value="MetalSystem3" type="number" />
    ...
    <ConfigInput iconType="icon" iconId="headlamp1" value="HeadLamp1Intensity" type="number" />
    <ConfigInput iconType="icon" iconId="headlamp1" value="HeadLamp1AttenuationRadius" type="number" />
    <ConfigInput iconType="icon" iconId="headlamp1" value="HeadLamp1LightFalloffExponent" type="number" />
    <ConfigInput iconType="icon" iconId="headlamp2" value="HeadLamp2Intensity" type="number" />
    <ConfigInput iconType="icon" iconId="headlamp2" value="HeadLamp2AttenuationRadius" type="number" />
    <ConfigInput iconType="icon" iconId="headlamp2" value="HeadLamp2LightFalloffExponent" type="number" />
